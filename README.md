...
# cp /<location_of_efivar>/efivar-37.tar.bz2 $LFS/sources/
# cp /<location_of_efivar-patch>/efivar-37-gcc_9-1.patch $LFS/sources/
# cp /<location_of_efibootmgr>/efibootmgr-17.tar.gz $LFS/sources/
# cp /<location_of_popt>/popt-1.18.tar.gz $LFS/sources/
```
